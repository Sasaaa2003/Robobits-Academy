...
class SulitLevel2SulitIntroPage extends StatefulWidget {
  ...
  State<SulitLevel2SulitIntroPage> createState() =>
      _SulitLevel2SulitIntroPageState();
}

class _SulitLevel2SulitIntroPageState
    extends State<SulitLevel2SulitIntroPage>
  ...
  void initState() {
    ...
    /// 🎵 SOUND DISAMAKAN DENGAN LEVEL SEBELUMNYA
    Level1Bgm.play();
  ...
  Future<void> _startSequence() async {
    ...
    // Pindah ke material level 2 sulit
    if (mounted) {
