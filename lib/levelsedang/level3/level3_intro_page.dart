...
class _SedangLevel3SedangIntroPageState extends State<SedangLevel3SedangIntroPage>
  ...
  Future<void> _startSequence() async {
    ...
    // ⏳ waktu baca teks (sedikit lebih lama)
    await Future.delayed(const Duration(seconds: 5));

    // Pindah ke material level 3 sedang
    if (mounted) {
            ...
            child: Column(
              ...
              children: [
                AnimatedBuilder(
                  ...
                  child: Image.asset(
                    "assets/robot.png",
                    height: 150, // 🔹 sedikit lebih dominan
                  ),
                ),
